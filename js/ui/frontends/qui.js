qwebirc.ui.QUI = new Class({
  ...
  createInput: function() {
    ...
    this.addEvent("signedOn", function(client) {
      ...
      inputbox.placeholder = "todo listo para chatear! puede escribir comandos como /JOIN";
...
qwebirc.ui.QUI.Window = new Class({
  ...
  initialize: function(parentObject, client, type, name, identifier) {
    ...
    this.tab.addClass("btn btn-sm btn-secondary");
    ...
    if(type == qwebirc.ui.WINDOW_CHANNEL) {
      ...
      this.nicklist.addClass("nicklist overflow-auto");
...
/*      var cmodes = this.client.getChannelModes(channel);
  ...
  select: function() {
    ...
    this.tab.removeClass("btn-secondary");
    this.tab.addClass("btn-dark");
  ...
  deselect: function() {
    ...
    this.tab.removeClass("btn-dark");
    this.tab.addClass("btn-secondary");
  },
  close: function() {
    this.parent();
