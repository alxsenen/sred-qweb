qwebirc.ui.ConnectPane = new Class({
  ...
  initialize: function(parent, options) {
    ...
    this.cookie = new Hash.Cookie("optconn", {duration: 103650, autoSave: false});
    var uiOptions = options.uiOptions;
    this.__windowName = "authgate_" + Math.floor(Math.random() * 100000);

    var delayfn = function() { parent.set("html", "<div class=\"loading\">Cargando. . .</div>"); };
  ...
  __validateLoginData: function() {
    ...
    if(!nickname) {
      alert("Debe tipear un nick/usuario.");
      nick.focus();
      return false;
    }
